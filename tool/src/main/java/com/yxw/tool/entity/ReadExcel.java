                ...
                if (null != cell) {
                    if (c == 1) {
                        ...
                        if (cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
                            ...
                            user.setNumber(number.substring(0, number.length() - 2 > 0 ? number.length() - 2 : 1));//性别
                        } else {
                            user.setNumber(cell.getStringCellValue());//性别
                        }
                    } else if (c == 2) {
                        if (cell.getCellType() == HSSFCell.CELL_TYPE_NUMERIC) {
                            String age = String.valueOf(cell.getNumericCellValue());
                            user.setDepId(age.substring(0, age.length() - 2 > 0 ? age.length() - 2 : 1));//年龄
                        } else {
                            user.setDepId(cell.getStringCellValue());//年龄
                        }
                    }
                }
            }
