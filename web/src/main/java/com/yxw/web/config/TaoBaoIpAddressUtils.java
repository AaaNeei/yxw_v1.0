   ...
   /* public static void main(String[] args){
    TaoBaoIpAddressUtils addressUtils = new TaoBaoIpAddressUtils();
        ...
        public static void main(String[] args) throws Exception{
            ...
            // 创建 GeoLite2 数据库
            //File database = new File("/g_city/GeoLite2-City.mmdb");
            File database = new File("F:\\yxw\\yxw01\\web\\src\\main\\resources\\g_city\\GeoLite2-City.mmdb");
            // 读取数据库内容
            DatabaseReader reader = new DatabaseReader.Builder(database).build();
            //InetAddress ipAddress = InetAddress.getByName(localHost.getHostAddress());
            InetAddress ipAddress = InetAddress.getByName("61.175.197.202");
