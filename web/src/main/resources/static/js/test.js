...
(function ($) {
    ...
    var _loading_config = {
        id: 'st_util_loading',
        img: '/res/images/loading_new.gif',
        zindex: '2000',
        isfade: false,
        time: 0,
        text: '加载中...',
    ...
    var Util = {
        openWin: function (url) {
            ...
            if (config.isfade)
                Util.createFade();
            var ele = "<div id='" + config.id + "' style='position:fixed;top:47%;left:49%;text-align:center;z-index:" + config.zindex + "'><table><tr>" + "<td><img width='60' height='60' src='" + config.img + "'/></td></tr>" + "<tr><td style='color:" + config.color + ";font-size:14px'>" + config.text + "</td>" + "</tr></table></div>";
            $("body").append(ele);
...
$.fn.hoverDelay = function (fnOver, fnOut, timeIn, timeOut) {
    var timeIn = timeIn || 200, timeOut = timeOut || 200, fnOut = fnOut || fnOver;
    ...
    this.each(function () {
        ...
        var h = function (a) {
            if (a != c) {
                ...
                if (l.effect == "fade") {
                    d.find(l.mainCell + ":eq(" + a + ")").fadeIn({queue: false, duration: 250})
                } else if (l.effect == "slide") {
                    d.find(l.mainCell + ":eq(" + a + ")").slideDown({queue: false, duration: 250})
                } else {
